...
import { BookOpen, ClipboardList, FileText, FolderGit2, LayoutGrid } from 'lucide-react';
...
const mainNavItems: NavItem[] = [
    ...
    { title: 'Work Orders', href: workOrdersIndex(), icon: ClipboardList },
    { title: 'Work Data', href: workDataIndex(), icon: FileText },
];
