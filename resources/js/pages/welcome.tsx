            ...
            <div className="flex min-h-screen flex-col bg-white dark:bg-[#050a14]">
                    ...
                    <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="grid flex-1 text-left">
                                <span className="text-lg font-bold tracking-tight leading-tight text-gray-900 dark:text-white">
                                    Optiwork
                                </span>
                ...
                <main className="flex-1">
                    <section className="relative min-h-screen overflow-hidden pt-20">
                        ...
                        <div className="absolute inset-0 bg-[linear-gradient(to_right,#0071b710_1px,transparent_1px),linear-gradient(to_bottom,#0071b710_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_at_center,black_30%,transparent_70%)] dark:bg-[linear-gradient(to_right,#0071b720_1px,transparent_1px),linear-gradient(to_bottom,#0071b720_1px,transparent_1px)]" />

                        <div ref={heroRef} className="relative mx-auto flex max-w-6xl items-center px-6 py-24 lg:min-h-[calc(100vh-5rem)] lg:py-32">
                            <div className="mx-auto max-w-3xl text-center">
                                ...
                                <p className="mx-auto mb-12 max-w-2xl animate-[fadeInUp_0.6s_ease-out_0.2s_both] text-lg leading-relaxed text-gray-500 dark:text-gray-400">
                                    Platform terpadu untuk mengelola proyek, tugas, dan kolaborasi tim perusahaan Anda.
                                    Bekerja lebih cerdas, cepat, dan efisien bersama Optiwork.
                                </p>
                                ...
                                <div className="flex animate-[fadeInUp_0.6s_ease-out_0.3s_both] flex-col items-center justify-center gap-4 sm:flex-row">
                                    {auth.user ? (
                                        ...
                                        >
                                            ...
                                            <svg className="relative z-10 size-4 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <>
                                            ...
                                            >
                                                ...
                                                <svg className="size-4 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                    <path d="M5 12h14M12 5l7 7-7 7" />
                                                </svg>
                                            </Link>
                                        </>
                        ...
                        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
                            <div className="flex size-10 items-center justify-center rounded-full border border-gray-200/50 bg-white/50 backdrop-blur-sm dark:border-white/10 dark:bg-white/5">
                                <svg className="size-5 text-gray-400 dark:text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <section className="relative overflow-hidden dark:bg-[#050a14]">
                        ...
                        <div ref={featuresRef} className="relative mx-auto max-w-6xl px-6 py-20 lg:py-28">
                            <div className="mx-auto mb-16 max-w-2xl text-center">
                                ...
                                <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                    Fitur-fitur yang dirancang untuk mengoptimalkan alur kerja dan meningkatkan efisiensi perusahaan Anda.
                                </p>
                            </div>
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                {features.map((feature, index) => (
                                    ...
                                    >
                                        {/* Card hover gradient */}
                                        <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 transition-opacity duration-500 group-hover:opacity-[0.03] dark:group-hover:opacity-[0.06]`} />

                                        {/* Icon */}
                                        <div className={`relative mb-5 inline-flex size-12 items-center justify-center rounded-xl bg-gradient-to-br ${feature.gradient} text-white shadow-lg shadow-[#0071b7]/20 transition-transform duration-300 group-hover:scale-110`}>
                                            {feature.icon}
                                        </div>
                                        ...
                                        <div className="relative mt-5 flex items-center gap-1.5 text-sm font-medium text-[#0071b7] opacity-0 transition-all duration-300 group-hover:opacity-100 dark:text-[#76c5f0]">
                                            ...
                                            <svg className="size-3.5 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                                <path d="M5 12h14M12 5l7 7-7 7" />
                                            </svg>
                                        </div>
                                    </div>
                        ...
                        <div className="relative mx-auto max-w-6xl px-6 py-20 lg:py-24">
                            <div className="mx-auto max-w-2xl text-center">
                                ...
                                <p className="mb-10 text-base leading-relaxed text-white/80">
                                    Bergabunglah dengan tim yang sudah menggunakan Optiwork untuk mengelola pekerjaan mereka secara efisien.
                                </p>
                                {auth.user ? (
                                    <Link
                                        href={dashboard()}
                    ...
                    <div className="mx-auto max-w-6xl px-6 py-8">
                        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
                            <div className="flex items-center gap-2.5">
                                ...
                                <div className="grid flex-1 text-left">
                                    <span className="text-sm font-semibold leading-tight text-gray-900 dark:text-white">Optiwork</span>
                                    <span className="text-[9px] font-medium tracking-wider text-gray-400 uppercase dark:text-gray-500">Work Management System</span>
                                </div>
                            </div>
                            <p className="text-sm text-gray-400 dark:text-gray-500">
                                &copy; {new Date().getFullYear()} Optiwork. Hak cipta dilindungi.
                            </p>
                        </div>
                    </div>
                </footer>
