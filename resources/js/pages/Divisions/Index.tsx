...
import { index, sync } from '@/routes/divisions';

type Division = {
    id_division: string;
    kode_division: string;
    nama_division: string | null;
    created_at: string;
    updated_at: string;
};
...
export default function DivisionIndex({ divisions, filters }: PageProps) {
    ...
    const handleSync = () => {
        ...
        router.post(sync.url(), {}, {
            onSuccess: () => {
                toast.success('Data divisi berhasil disinkronkan.');
            },
            onError: () => {
                toast.error('Gagal menyinkronkan data divisi.');
            },
            onFinish: () => {
                setSyncing(false);
            }
    ...
    // Helper to get initials of division name
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                            Lihat daftar divisi yang disinkronkan dari Optigate Portal
                        </p>
                    </div>
                    <Button
                        onClick={handleSync}
                                ...
                                >
                                    ...
                                    <div className="border-t border-neutral-100 px-5 py-3 dark:border-neutral-800 bg-neutral-50/30 dark:bg-neutral-900/10">
                                        <div className="flex items-center justify-between text-[11px] text-neutral-400 dark:text-neutral-500">
                                            ...
                                            <span>
                                                Updated:{' '}
                                                {new Date(div.updated_at).toLocaleDateString('en-US', {
                                                    month: 'short',
                                                    day: 'numeric',
                                                })}
                                            </span>
                    ...
                    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-300 bg-neutral-50/50 py-16 dark:border-neutral-700 dark:bg-neutral-900/50">
                        ...
                        <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                            {hasActiveFilters
                                ...
                                : 'Silakan klik tombol Sync untuk menarik data divisi dari Optigate.'}
                        </p>
                        {hasActiveFilters ? (
                            <Button
                                variant="outline"
