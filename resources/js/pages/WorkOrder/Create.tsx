                ...
                >
                    {({ processing, errors }) => (
                        <>
                            ...
                            <div className="overflow-hidden rounded-2xl border border-[#0071b7]/20 bg-gradient-to-br from-[#0071b7]/5 via-white to-[#0093dd]/5 p-6 dark:border-[#0093dd]/20 dark:from-[#0093dd]/5 dark:via-neutral-900 dark:to-[#0093dd]/5">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between rounded-lg border border-neutral-200/60 bg-white px-4 py-3 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                                        <span className="text-sm text-neutral-700 dark:text-neutral-300">Work Order Number</span>
                                        <span className="rounded-full bg-[#0071b7]/10 px-3 py-1 text-xs font-mono font-semibold text-[#0071b7] dark:bg-[#0093dd]/20 dark:text-[#0093dd]">
                                            Auto-generated
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-lg border border-neutral-200/60 bg-white px-4 py-3 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                                        <span className="text-sm text-neutral-700 dark:text-neutral-300">Work Order Date</span>
                                        <span className="text-sm font-semibold text-neutral-900 dark:text-white">Today's date</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-lg border border-neutral-200/60 bg-white px-4 py-3 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                                        <span className="text-sm text-neutral-700 dark:text-neutral-300">Initial Status</span>
                                        <span className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-3 py-1 text-xs font-semibold text-white shadow-sm">
                                            <span className="size-1.5 rounded-full bg-white/50 animate-pulse" />
                                            Pending HOD Review
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-lg border border-neutral-200/60 bg-white px-4 py-3 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                                        <span className="text-sm text-neutral-700 dark:text-neutral-300">Reporter</span>
                                        <span className="text-sm font-semibold text-neutral-900 dark:text-white">Current user</span>
                                    </div>
                                </div>
                            </div>
